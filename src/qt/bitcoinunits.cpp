...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("V");
    case mBTC: return QString("mV");
    case uBTC: return QString::fromUtf8("μV");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Versions");
    case mBTC: return QString("Milli-Versions (1 / 1,000)");
    case uBTC: return QString("Micro-Versions (1 / 1,000,000)");
    default: return QString("???");
    }
}
