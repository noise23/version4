...
// Modifier interval reduced to 40-minute
unsigned int nModifierIntervalNew = MODIFIER_INTERVAL_V2;
...
static int64_t GetStakeModifierSelectionIntervalSection(int nSection, unsigned int nActualModifierInterval)
{
...
static int64_t GetStakeModifierSelectionInterval(unsigned int nActualModifierInterval)
{
...
bool ComputeNextStakeModifier(const CBlockIndex* pindexPrev, uint64_t& nStakeModifier, bool& fGeneratedStakeModifier)
{
    ...
    int64_t nSelectionInterval = GetStakeModifierSelectionInterval(nActualModifierInterval);
    int64_t nSelectionIntervalStart = (pindexPrev->GetBlockTime() / nActualModifierInterval) * nActualModifierInterval - nSelectionInterval;
...
static bool GetKernelStakeModifier(uint256 hashBlockFrom, uint64_t& nStakeModifier, int& nStakeModifierHeight, int64_t& nStakeModifierTime, bool fPrintProofOfStake)
{
    ...
    int64_t nStakeModifierSelectionInterval = GetStakeModifierSelectionInterval(nActualModifierInterval);
